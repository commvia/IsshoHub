...
(function (global) {
  ...
  const ICONS = {
    ...
    torii: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M1 22L10 9 12 4 14 9 23 22"/><path d="M8.5 12h7"/><path d="M1 22h22"/></svg>`,
