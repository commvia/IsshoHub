...
(function (global) {
  ...
  const ICONS = {
    ...
    torii: `<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M3 19L10 11 12 8 14 11 21 19"/><path d="M10.5 12L12 8.5 13.5 12"/><path d="M3 19h18"/><path d="M5 7Q7 5 9 7"/><path d="M10.5 6Q12 4.5 13.5 6"/><path d="M15 7Q17 5 19 7"/></svg>`,
